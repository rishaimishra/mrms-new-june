...
class SummaryExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping, WithTitle, WithEvents
{
    ...
    public function __construct(Collection $propertiesQuery,$batch, $ward,$due_2024,$paid_2024,$arrears,$year)
    {
    ...
    public function map($row): array
    {
        ...
        $paid_2024_value = isset($this->paid_2024[$this->rowIndex]) ? $this->paid_2024[$this->rowIndex] : 0;
        $arrears = isset($this->arrears[$this->rowIndex]) ? $this->arrears[$this->rowIndex] : 0;
    ...
    {
        return "SUMMARY FOR BATCH {$this->batch} WARD {$this->ward} YEAR {$this->year}";
        // return "TEST TITLE";
    }
