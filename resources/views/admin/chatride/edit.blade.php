...
<form action="{{ route('admin.chat_a_ride.update') }}" method="POST" enctype="multipart/form-data">
  @csrf

  <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        <h2>Create New chataride Category</h2>
      </div>
  ...
  <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card" style="min-height: 300px;">
                <div class="body">
                    <label for="image">Image</label>
                     ...
                     <input type="file" name="image_chat" id="image" onchange="previewImage(event)" />
    ...
    <div class="card" style="min-height: 300px;">
       ...
       <script>
            ...
            <form action="{{ route('admin.chat_a_ride.destroy', $serviceCategory->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this service category?');">
                @csrf
                @method('DELETE')
