...
<form action="{{ route('admin.chat_a_ride.add') }}" method="POST" enctype="multipart/form-data">
  @csrf

  <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        <h2>Create chat-a-ride Category</h2>
      </div>
  ...
  <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="card">
      <div class="body">
        ...
        <input type="file" name="image_chat" id="image" />
      </div>
    </div>
