...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <form action="{{ route('admin.starsubscription-store') }}" method="POST">
            @csrf
            <div class="body">
                <div class="row">
                    <div class="col-sm-6">
    ...
    <div class="card">
        <div class="header">
            <h2>Star Subscription detail</h2>
        </div>
        <div class="body">
            <div class="row">
                <table class="table ">
                    ...
                    <tbody>
                        @foreach ($dstv as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.starsubscription-edit', ['id' => $item->id]) }}"><i class="material-icons">edit</i></a>
                                    <a href="{{ route('admin.starsubscription-delete', ['id' => $item->id]) }}"><i class="material-icons">delete</i></a>
                                   </td>
                            </tr>
                        @endforeach
                    </tbody>
