...
@section('grid-content')
                    <div class="card">
                        <div class="body">
                        {!! Form::open(['route' => ['admin.payment.update', 1], 'method' => 'PUT']) !!}
                        @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div>
                                            <label>Payment Deliveries Text</label>
                                            <textarea  name="title" style="width: 500px; height: 100px;">{{ $paymentsDeliveries ? $paymentsDeliveries->title : '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
