...
<style>
    .login-page {
        background-image: url('https://i.ibb.co/r7FD59B/Whats-App-Image-2024-10-14-at-5-38-33-PM.jpg') !important;
        margin: 7% 2% 5% auto !important;
        background-repeat: no-repeat !important;
        background-size: cover !important;
    }
</style>
    {{--  {!! Form::open(['novalidate' => 'novalidate', 'id' => 'sign_in']) !!}  --}}
    <form action="{{ route('admin.seller.login') }}" method="post">
        @csrf
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <button type="submit" class="btn btn-block btn-primary waves-effect">SIGN IN</button>
            {{--  <a href="{{ route('admin.sellerDashboard') }}" class="btn btn-block btn-primary waves-effect">SIGN IN</a>  --}}
