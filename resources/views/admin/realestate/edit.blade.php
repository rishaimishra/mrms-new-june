...
@section('content')
    ...
    @isset($realEstate->id)
        {!! Form::model($realEstate, ['files' => true, 'route' => ['admin.real-estate.update', $realEstate->id],'method' => 'PATCH']) !!}
    @else
                ...
                <div class="body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{ old('name',optional($realEstate)->name) }}"
                                           name="name" required>
                            ...
                            @if(! isset($realEstate->id) || ! $attributeGroups)
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            {!! Form::text('title', old('title', $realEstate->title), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            {!! Form::textarea('about', old('about', $realEstate->about), ['class' => 'form-control', 'rows' => 5,'id'=>'about']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="text" class="form-control"
                                   value="{{$realEstate->addressArea->name}}" id="area" name="area" required
                                   autocomplete="false">

                            <input type="hidden" name="address_area_id" id="address_area_id"
                                   value="{{$realEstate->area_id}}">

                            <input type="hidden" name="address_id" id="address_id" value="{{$realEstate->address_id}}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="ward" id="ward"
                                           value="{{$realEstate->address->ward_number}}" required readonly="true">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="constituency" id="constituency"
                                           value="{{$realEstate->address->constituency}}" required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="address_section_id" class="form-control selectpicker" id="section">
                                ...
                                @if($realEstate->address)
                                    @foreach($realEstate->address->addressSection as $key=>$value)
                                        <option
                                            value="{{$value->id}}" {{($value->id==$realEstate->section_id)?"selected":""}}>{{$value->name}}</option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <select name="address_chiefdom_id" class="form-control selectpicker" id="chiefdom">
                                        <option value="">Select</option>
                                        @if($realEstate->address)
                                            @foreach($realEstate->address->addressChiefdom as $key=>$value)
                                                <option
                                                    value="{{$value->id}}" {{($value->id==$realEstate->chiefdom_id)?"selected":""}}>{{$value->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @if ($errors->has('chiefdom'))
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="district" id="district" required
                                           readonly="true" value="{{$realEstate->address->district}}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="province" id="province" required
                                           readonly="true" value="{{$realEstate->address->province}}">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    {!! Form::text('address', old('address', ($realEstate->map_addresses)), ['class' => 'form-control', 'id' => 'address']) !!}
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-12">
                        ...
                        <textarea id="businessHoursOutput" name="availability_times"
                                  style="display: none">{{ old('availability_times',json_encode($realEstate->availability_times))  }}</textarea>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    {!! Form::text('meta_tag1', old('meta_tag1', ($realEstate->meta_tag1)), ['class' => 'form-control', 'id' => 'meta_tag1']) !!}
                                </div>
                            </div>
                                        ...
                                        <div class="form-line{{ $errors->has($attribute->attribute_code) ? ' error' : '' }}">
                                            ...
                                            <select class="form-control" name="{{ $attribute->attribute_code }}">
                                                ...
                                                @foreach($attribute->optionValues as $option)
                                                    <option {{ old($attribute->attribute_code, $realEstate->{$attribute->attribute_code}) == $option->label ? "selected" : "" }} {!! $option->is_featured == 1 ? 'style="font-weight: bold; color: #000"' : '' !!} value="{{ $option->label }}">{{ $option->label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
        ...
        <div class="col-lg-4">
                ...
                <div class="body">
                    <div class="custom-control custom-checkbox">
                        ...
                        <input type="checkbox" name="is_available" value="1" class="custom-control-input filled-in"
                               id="customCheck2" {{old('is_available',optional($realEstate)->is_available)==1?'checked':''}} >
            ...
            <div class="card">
                ...
                <div class="body list-tree">
                    ...
                    @endif
                    @include('admin.realestate.categories', ['categories' => $categories, 'parent' => null])
                </div>
            </div>
        </div>
    </div>
    {!! Form::close() !!}
    @isset($realEstate->id)
        {!! Form::open(['route' => ['admin.real-estate.destroy', $realEstate->id], 'method' => 'DELETE','class'=>'delete','id'=>'deleteForm']) !!}
...
@push('before_body_close')
        ...
        function imgdelete(id) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    ...
                    type: 'GET',
                    url: "{{url('/sl-admin/imageDelete/real-estate')}}/" + id,
                    success: function (data) {
    ...
    <script>
        ...
        var latt = {{$realEstate->latitude ?? 8.4871072}};
        var lngg = {{$realEstate->longitude ?? -13.235809}};
        var add = "{{$realEstate->map_addresses ?? "32 Walpole St, Freetown, Sierra Leone"}}";
