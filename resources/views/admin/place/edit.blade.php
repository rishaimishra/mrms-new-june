...
@section('content')
    ...
    @isset($place->id)
        {!! Form::model($place, ['files' => true, 'route' => ['admin.place.update', $place->id],'method' => 'PATCH']) !!}
    @else
        {!!Form::open(['route' => 'admin.place.store','files' => true]) !!}
    @endisset
        ...
        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="col-md-12 multi-img-upload">
                                ...
                                <ul  style="list-style: none; margin: 0; padding: 0; ">
                                    @foreach($place->images as $image)
                                        ...
                                        <li style="float: left;width: 300px">
                                            ...
                                            <div class="padding-img">
                                                <img class="lazy" src="{{ asset('storage/' . $image->image) }}" alt=""
                                                     style="width: 40%">
                                                <span>
                                                <a href="#" class="fancybox"><i class="far fa-eye"></i></a>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{ old('name',optional($place)->name) }}"
                                           name="name" required>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            {!! Form::text('title', old('title', optional($place)->title), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            {!! Form::textarea('about', old('about', $place->about), ['class' => 'form-control', 'rows' => 5,'id'=>'about']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="text"  class="form-control"
                                   value="{{old("area",$place->addressArea->name)}}" id="area" name="area" required
                                   autocomplete="false">

                            <input type="hidden" name="address_area_id" id="address_area_id"
                                   value="{{old('address_area_id',$place->area_id)}}">

                            <input type="hidden" name="address_id" id="address_id" value="{{old('address_id',$place->address_id)}}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="ward" id="ward"
                                           value="{{old('ward',$place->address->ward_number)}}" required readonly="true">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="constituency" id="constituency"
                                           value="{{old('constituency',$place->address->constituency)}}" required>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <select name="address_section_id" class="form-control selectpicker" id="section">
                                ...
                                @if($place->address)
                                    @foreach($place->address->addressSection as $key=>$value)
                                        <option value="{{$value->id}}" {{($value->id==old('address_section_id',$place->section_id))?"selected":""}}>{{$value->name}}</option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <select name="address_chiefdom_id" class="form-control selectpicker" id="chiefdom">
                                        <option value="">Select</option>
                                        @if($place->address)
                                            @foreach($place->address->addressChiefdom as $key=>$value)
                                                <option value="{{$value->id}}" {{($value->id==old('address_chiefdom_id',$place->chiefdom_id))?"selected":""}}>{{$value->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @if ($errors->has('chiefdom'))
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="district" id="district" required
                                           readonly="true" value="{{old('district',$place->address->district)}}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="province" id="province" required
                                           readonly="true" value="{{old('province',$place->address->province)}}">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    {!! Form::text('address', old('address', ($place->map_addresses)), ['class' => 'form-control', 'id' => 'address']) !!}
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-12">
                        ...
                        <textarea id="businessHoursOutput" name="availability_times"
                                  style="display: none">{{ old('availability_times',json_encode($place->availability_times))  }}</textarea>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    {!! Form::text('meta_tag1', old('meta_tag1', ($place->meta_tag1)), ['class' => 'form-control', 'id' => 'meta_tag1']) !!}
                                </div>
                            </div>
            ...
            <div class="card">
               ...
               {{--<div id="treeview_container" class="hummingbird-treeview" style="height: 230px; overflow-y: scroll;">--}}
                ...
                <div class="list-tree" >
                    ...
                    @endif
                    @include('admin.place.categories', ['categories' => $categories, 'parent' => null])
                </div>
                </div>
                {{--</div>--}}
            </div>
    ...
    {!! Form::close() !!}
    @isset($place->id)
        {!! Form::open(['route' => ['admin.place.destroy', $place->id], 'method' => 'DELETE','class'=>'delete','id'=>'deleteForm']) !!}
...
@push("before_head_close")
    <style type="text/css" media="screen">
        ...
        .typeahead { border: 2px solid #FFF;border-radius: 4px;padding: 8px 12px;max-width: 300px;min-width: 290px;background: #1f3f41f2;color: #FFF;}
        .tt-menu { width:300px; }
        ul.typeahead{margin:0px;padding:10px 0px;top:100px !important;}
    ...
    {{--<link href="{{ url('admin/css/hummingbird-treeview.css') }}" rel="stylesheet"/>
...
@push('before_body_close')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(old("area",$place->addressArea->name))

                let query = '{{old("area",$place->addressArea->name)}}';
                $.ajax({
    ...
    <script>
        ...
        function imgdelete(id){
            if(confirm("Are you sure?")) {
                $.ajax({
                    ...
                    type: 'GET',
                    url: "{{url('/sl-admin/imageDelete/place')}}/" + id,
                    success: function (data) {
        ...
        if ($("#businessHoursOutput").val() != 'null') {
            ...
            $("#businessHoursContainer3").businessHours({
                ...
                operationTime: [{"is_active":false,"timeFrom":null,"timeTill":null},{"is_active":false,"timeFrom":null,"timeTill":null},{"is_active":false,"timeFrom":null,"timeTill":null},{"is_active":false,"timeFrom":null,"timeTill":null},{"is_active":false,"timeFrom":null,"timeTill":null},{"is_active":false,"timeFrom":null,"timeTill":null},{"is_active":false,"timeFrom":null,"timeTill":null}],
                dayTmpl: '<div class="dayContainer" style="width: 12%;">' +
                    '<div data-original-title="" class="colorBox"><input type="checkbox" class="invisible operationState"><div class="weekday"></div></div>' +
                    '<div class="operationDayTimeContainer">' +
                    '<div class="operationTime input-group"><span class="input-group-addon"><i class="far fa-sun"></i></span><input type="text" name="startTime" class="mini-time form-control operationTimeFrom" value=""></div>' +
    ...
    <script>
        ...
        var latt = {{$place->latitude ?? 8.4871072}};
        var lngg = {{$place->longitude ?? -13.235809}};
        var add = "{{$place->map_addresses ?? "32 Walpole St, Freetown, Sierra Leone"}}";
