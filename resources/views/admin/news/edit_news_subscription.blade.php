...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <form action="{{ route('admin.newssubscription-update') }}" method="POST">
            @csrf
        ...
        <div class="body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <label class="form-label">Individual plan refferal %</label>
                ...
                <div class="col-sm-6">
                    <label class="form-label">Business Plan refferal %</label>
