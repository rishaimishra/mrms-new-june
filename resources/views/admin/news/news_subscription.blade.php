...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <form action="{{ route('admin.newssubscription-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.newssubscription-edit', ['id' => $headline->id]) }}" class="btn btn-primary">View</a>
                        <a href="{{ route('admin.newssubscription-delete', ['id' => $headline->id]) }}" class="btn btn-danger">Delete</a>
                    </td>
                   </tr>
                  @endforeach
