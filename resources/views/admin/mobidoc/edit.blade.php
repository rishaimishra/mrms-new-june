...
<form action="{{ route('admin.movie_doc.update') }}" method="POST" enctype="multipart/form-data">
  @csrf

  <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        <h2>Create New mobi doc Category</h2>
      </div>
        ...
        <div class="body">
            ...
            <div class="card" style="min-height: 300px;">
                <div class="body">
                    ...
                    <input type="file" name="mobi_image" id="image" onchange="previewImage(event)" />
...
<form action="{{ route('admin.movie_doc.destroy', $serviceCategory->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this service category?');">
                @csrf
                @method('DELETE')
