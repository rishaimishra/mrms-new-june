            ...
            <tr>
                ...
                <th>Action</th>
                    ...
                    <td>
                        ...
                        <button type="button" onclick="window.location.href='{{ route('admin.edit-auto.seller', ['id' => $category->id]) }}'" class="item" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit">
