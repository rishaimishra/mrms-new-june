...
<table style="width:100%">
    <tr>
        ...
        <td style="width:20%">
            <img src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('img/trans_powered_by_dstv.png')))}}" class="header-image-right" alt="Image" height="150" widht="150"/>
        </td>
    </tr>
</table>
<hr>
...
<table style="width:100%; margin-top:20px;">
    <tr>
        ...
        <!-- <td style="width:50%;color:#fff; font-family: 'Trebuchet MS', sans-serif; font-weight:bold; font-size:15px;">
            <p style="background-color: #0096FF; padding:10px;">DATE:</p>
        </td> -->
    ...
    <tr>
        ...
        <td style="width:20%;"></td>
        <td style="width:20%;"></td>
        <td  style="width:100%; text-align: right;margin-left:20px">
