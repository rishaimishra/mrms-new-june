...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <form action="{{ route('admin.seller.newssubscription-store.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="border_cus">
                <div class="row">
                    <div class="col-md-2"><label for="">HEADLINE</label></div>
                    <div class="col-md-10">
                        <textarea rows="2"  class="form-control" name="headline" placeholder="enter headline here ......." >{{$hd->headline}}</textarea>
                ...
                <div class="row"style="margin-top:10px;">
                    ...
                    <div class="col-md-10">
                        ...
                        <textarea rows="1"  class="form-control" name="editor_name" placeholder="enter editor name here .......">{{$hd->editor_name}}</textarea>
                        <input type="hidden" name="news_id" value="{{$hd->id}}">
                ...
                <div class="row"style="margin-top:10px;">
                    ...
                    <div class="col-md-10">
                        {{--  <textarea  class="form-control" name="story_board" placeholder="enter news story here .......">  --}}
                        <textarea rows="2"  class="form-control" name="headline_description" placeholder="enter headline description here .......">{{$hd->headline_description}}</textarea>
            ...
            <div class="border_cus" style="margin-top: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <textarea name="story_board" id="editor">{{$hd->story_board}}</textarea>
