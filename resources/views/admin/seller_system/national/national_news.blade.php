...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <form action="{{ route('admin.seller.national-news-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.seller.national-news-edit', ['id' => $headline->id]) }}" class="btn btn-primary">View</a>
                        <a href="{{ route('admin.seller.national-news-edit-save', ['id' => $headline->id]) }}" class="btn btn-warning">Edit</a>
                        <a href="{{ route('admin.seller.national-news-delete', ['id' => $headline->id]) }}" class="btn btn-danger">Delete</a>
                    </td>
                   </tr>
                  @endforeach
