                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="row">
                      ...
                      <div class="col-md-10">
                        <textarea rows="1"  class="form-control" name="headline" placeholder="enter headline here ......." >{{$hd->headline}}</textarea>
                      ...
                      {{--  <textarea  class="form-control" name="story_board" placeholder="enter news story here .......">  --}}
                          <textarea rows="1"  class="form-control" name="headline_description" placeholder="enter headline description here .......">{{$hd->headline_description}}</textarea>
