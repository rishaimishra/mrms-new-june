...
Route::group(['as' => 'auth.', 'namespace' => 'Auth'], function () {
    ...
    Route::get('update-years-value', 'LoginController@updateYearsValue');
});
...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    Route::group(['middleware' => ['role:Super Admin|Admin|manager']], function () {
        ...
        // Route::get('test_upload', 'PropertyController@test_update')->name('test');
        ...
        //PaymentStreetNameApplication
        Route::get('payment/street-applications', 'PaymentStreetNameApplication@index')->name('payment.street-application');
        Route::post('payment/street-applications/store', 'PaymentStreetNameApplication@store')->name('payment.street-application.store');
    });
    ...
    Route::get('app-user/create-user', 'AppUserController@create')->name('app-user.create-user');
    ...
    Route::get('street-name-application/setting/communities/{id}/get-community', 'AdminStreetNameApplication@getCommunityByWards')->name('street_name_application.setting.get-community-by-wards');
...
Route::get('get_property_detail', 'PropertyController@get_property_detail')->name('property.detail');
Route::post('property/excel/download/waybill', 'PropertyController@download_waybill_excel')->name('waybill.download');
